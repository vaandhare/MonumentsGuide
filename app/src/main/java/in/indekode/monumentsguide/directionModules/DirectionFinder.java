package in.indekode.monumentsguide.directionModules;
...
public class DirectionFinder {
    ...
    private static final String GOOGLE_DIRECTION_API_KEY = "AIzaSyBz2qTdopZYydR**Fd1Vaes14Azzxej***";  // replace with your google direction api
