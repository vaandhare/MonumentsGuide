    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tajmahal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "27.1751");
                intent.putExtra("Lang", "78.0421");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource
                        (getResources(), R.drawable.imgtaj);
        ...
        mysorepalace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "12.3051");
                intent.putExtra("Lang", "76.6551");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource
                        (getResources(), R.drawable.imgmysorepalace);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        goldentemple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "31.6200");
                intent.putExtra("Lang", "74.8765");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource
                        (getResources(), R.drawable.imggoldentemple);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        hindutemple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("EntryFees", "Entry Fee: FREE");
                intent.putExtra("Lat", "9.9195045");
                intent.putExtra("Lang", "78.1193418");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource
                        (getResources(), R.drawable.imgmeenakshitemple);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        hawamahal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "26.9239");
                intent.putExtra("Lang", "75.8267");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource
                        (getResources(), R.drawable.imghawamahal);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        victoriamemorial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "22.5448");
                intent.putExtra("Lang", "88.3426");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource (getResources(), R.drawable.imgvictoria);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        qutubminar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "28.5245");
                intent.putExtra("Lang", "77.1855");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource (getResources(), R.drawable.imgqutub);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        lotustemple.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("EntryFees", "Entry Fee: FREE");
                intent.putExtra("Lat", "28.5535");
                intent.putExtra("Lang", "77.2588");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource (getResources(), R.drawable.imglotustemple);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        lalqila.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "28.6562");
                intent.putExtra("Lang", "77.2410");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource (getResources(), R.drawable.imglalqila);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
        ...
        shaniwarwada.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Lat", "18.5195");
                intent.putExtra("Lang", "73.8553");
                ...
                Bitmap bitmap = BitmapFactory.decodeResource (getResources(), R.drawable.imgshaniwarwada);
                ByteArrayOutputStream bs = new ByteArrayOutputStream();
                bitmap.compress(Bitmap.CompressFormat.JPEG, 50, bs);
                intent.putExtra("byteArray", bs.toByteArray());
